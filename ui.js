      ...
      <div class="card card-body mb-3">
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <span class="badge badge-danger mb-2">Public Gists: ${
              user.public_gists
            }</span>
      ...
      output += `
        <div class="card card-body mb-2">
          <div class="row">
            ...
            <div class="col-md-6">
            <span class="badge badge-danger mb-2">Stars: ${
              repo.stargazers_count
            }</span>
            <span class="badge badge-primary mb-2">Watchers: ${
              repo.watchers_count
            }</span>
            <span class="badge badge-info mb-2">Forks: ${
              repo.forks_count
            }</span>
            </div>
          </div>
